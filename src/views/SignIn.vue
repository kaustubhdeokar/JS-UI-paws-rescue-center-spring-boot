    ...
    <div class="row">
      <div class="col-12 text-center pt-3">
        <router-link :to="{name : 'HomeView'}">
          <img id="logo" alt="alt" src="../assets/icon.png" />
        </router-link>
      </div>
    </div>
    <div class="row">
      <div class="col-12 justify-content-center d-flex flex-row pt-5">
        <div id="signin-div" class="flex-item border">
          ...
          <form @submit="signin" class="pt-4 pl-4 pr-4">
            ...
            <small class="form-text text-muted">By continuing, you agree to conditions of use and privacy notice.</small>
          ...
          <hr>
          <small class="form-text text-muted pt-2 pl-4 text-center">New?</small>
          <p class="text-center">
            <router-link :to="{name: 'SignUp'}" class="btn btn-dark text-center mx-auto px-5 py-1 mb-2">Create Account</router-link>
          </p>
        </div>
      </div>
    </div>
